...
class GeminiService {
  ...
  // IMPORTANT: In production, store this in environment variables or secure storage
  // read the API key from 'GEMINI_API_KEY.txt' file
  static final String _apiKey = File(
    'GEMINI_API_KEY.txt',
